...
<section className="mx-auto max-w-[1440px] px-6 lg:px-12 my-[99px]">
   ...
   <div className='pb-2 relative'>
    ...
    <div className='flex gap-x-4'>
       ...
       <div className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
        ...
        <MdOutlineBed/>{data?.facilities?.[0].bedrooms}
       </div>

       <div className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>

        <MdOutlineBathtub/>{data?.facilities?.[0]?.bathrooms}
       </div>
       <div className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
        <MdOutlineGarage/>{data?.facilities?.[0]?.parkings}
       </div>
