...
export const api=axios.create({
    baseURL :"https://real-estate-project-ashen.vercel.app/api"
})
...
export const bookVisit=async(date,propertyId,email,token) =>{
    ...
    try{
        ...
        await api.post(`/user/bookVisit/${propertyId}`,{email,
         id:propertyId,
   ...
   headers:{
    ...
    Authorization:`Bearer ${token}`,
        ...
        toast.error('Somethong went wrong, Try again please ')
        throw error
...
export const getAllBookings =async (email,token)=> {
    ...
    try{
        ...
        toast.error("Something went wrong while fetching your bookings list")
        throw e
    }
